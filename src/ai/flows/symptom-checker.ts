...
const prompt = ai.definePrompt({
  ...
  **Your response MUST follow this structure:**
  ...
  2.  **precautionsAndSuggestions**: Provide a detailed, structured, and conversational response that includes:
      ...
      - A "**Self-care steps**" section with a bulleted list (using '*') of actionable advice. Each bullet point should be a complete sentence and not contain its own heading (e.g., "* Get plenty of rest to help your body recover.").
      - A "**When to see a doctor urgently**" section with a bulleted list (using '*') of serious symptoms that warrant immediate medical attention. Each point should be a complete sentence.
